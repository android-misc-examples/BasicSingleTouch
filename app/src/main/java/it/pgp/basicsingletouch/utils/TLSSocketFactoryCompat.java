...
/**
 * Imported from org.schabi.newpipe
 * This is an extension of the SSLSocketFactory which enables TLS 1.2 only.
...
public class TLSSocketFactoryCompat extends SSLSocketFactory {
    ...
    public TLSSocketFactoryCompat(Object noCertVerificationPlaceholderParam)
            throws KeyManagementException, NoSuchAlgorithmException {
        this(new TrustAllX509TrustManager[]{new TrustAllX509TrustManager()});
    }
    ...
    // we are using plain TLS, this is unneeded here - do not ever try to use https without verifying certs!
